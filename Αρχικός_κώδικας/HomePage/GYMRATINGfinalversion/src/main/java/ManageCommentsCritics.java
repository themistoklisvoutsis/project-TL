public class ManageCommentsCritics {
    private DBManagerGR dbManager;

    public ManageCommentsCritics() {
        this.dbManager = new DBManagerGR();
    }
    ...
    public void checkRating(String clientId, String gymName, double rating) {
        if (checkMembership(clientId)) {
