...
public class GymOwnerInitialScreenFD {
    ...
    public static void showHistory() {
        ...
        List<String> results = DBManagerFD.searchForTimeDomain(Date.valueOf("2000-01-01"), new Date(System.currentTimeMillis()));
    ...
    public static void comparePeriods() {
        ...
        List<String> current = DBManagerFD.searchForTimeDomain(currentFrom, currentTo);
        List<String> previous = DBManagerFD.searchForTimeDomain(previousFrom, previousTo);
