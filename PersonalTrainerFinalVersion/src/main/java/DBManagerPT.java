...
import java.sql.ResultSet;
    ...
    try {
        ...
        String sql = "SELECT DayOfWeek, StartTime, EndTime " +
                    ...
                    "ORDER BY FIELD(DayOfWeek, 'Δευτέρα', 'Τρίτη', 'Τετάρτη', 'Πέμπτη', 'Παρασκευή', 'Σάββατο', 'Κυριακή'), " +
                    "StartTime";
        ...
        try {
            ...
            System.out.println("Σφάλμα κατά το κλείσιμο του PreparedStatement: " + e.getMessage());
        }
    }
}
